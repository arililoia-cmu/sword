...
// // This can viably describe all the sorts of "units" that will be in the game (players + enemies)
// // That's all it's intended to describe -- not stuff like projectiles, movable objects, etc.
// class Creature
// {
// 	virtual ~Creature() = 0;
...
// 	// Done this way since every creature will have a body that can be hit (otherwise it's not a creature)
